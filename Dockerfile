...
# Entrypoint supporting both local port 8501 and cloud platform $PORT (Render, Cloud Run)
CMD ["sh", "-c", "streamlit run 3_app.py --server.port ${PORT:-8501} --server.address 0.0.0.0"]
